...
empqcols <- c("empq1", "empq2", "empq3", "empq4", "empq5", "empq6", "empq7", "empq8", "empq9", "empq10", "empq11", "empq12", "empq13", "empq14", "empq15", "empq16", "empq17", "empq18", "empq19")
...
Are there any discrepancies? While you are at it, comment on the levels of
...
Comment on your choice of which standard errors to compute. How many times do
you reject the null at the 5% level? Roughly how many rejections would you expect
under the null of random assignment? Second, regress the treatment dummy on all
the variables together and conduct a joint test for balance. Explain your choice of
